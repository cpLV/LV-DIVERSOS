...
var Main = module(function() {
	...
	function init() {
		...
		loading(true)
		$.get('https://rawcdn.githack.com/Mariolv/LV-DIVERSOS/d80ce82668564e31ae9ccb3324f078340cbe444b/PACTOMETROS/data_pactometro26M_comunidad_madrid.json', function(res) {
			loading(false);
