...
var Main = module(function() {
	...
	function init() {
		...
		loading(true)
		$.get('https://rawcdn.githack.com/Mariolv/LV-DIVERSOS/b7b383292e6b656727bc1393faf370d98a148d9d/PACTOMETROS/data_pactometro26M_comunidad_madrid.json', function(res) {
			loading(false);
