...
var Main = module(function() {
	...
	function init() {
		...
		loading(true)
		$.get('https://rawcdn.githack.com/Mariolv/LV-DIVERSOS/89168f9eaa5863012930e7e0a7a4599f8fa17724/PACTOMETROS/data_pactometro26M_ayuntamiento_cadiz.json', function(res) {
			loading(false);
