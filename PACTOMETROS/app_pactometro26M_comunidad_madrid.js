...
var Main = module(function() {
	...
	function init() {
		...
		loading(true)
		$.get('https://rawcdn.githack.com/Mariolv/LV-DIVERSOS/fb668831e2d69ed847d80ca52166dd31d41d35c2/PACTOMETROS/data_pactometro26M_comunidad_madrid.json', function(res) {
			loading(false);
