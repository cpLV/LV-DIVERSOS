...
var Main = module(function() {
	...
	function init() {
		...
		loading(true)
		$.get('https://rawcdn.githack.com/Mariolv/LV-DIVERSOS/4aa57ffc317e562f18119f741b28ab8120570080/PACTOMETROS/data_pactometro26M_ayuntamiento_cadiz.json', function(res) {
			loading(false);
